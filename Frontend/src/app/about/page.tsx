...
export default function About() {
  return (
    <div>
      ...
      <h2>About</h2>
      <p>
        Result-driven Java backend software developer with a strong track record
        of 3 years, focused on designing, developing, optimizing performance,
        and maintaining billing and payment systems within Telecom BSS stacks.
        Dedicated to achieving high-quality outcomes, skilled in effective
        debugging, and adept at maintaining a smooth coding and personal
        workflow. Proficient in tailoring solutions to address unique needs. A
        clear and collaborative communicator with a sincere commitment to task
        ownership. Enthusiastic about creating clean code that not only performs
        but is also enjoyable to work with.
      </p>
      ...
      <ul>
        <li>
          Exceeded SLA expectations by significantly accelerating billing core
          systems to handle bill-runs ,settlements and financial management for
          millions of simultaneous services.
        </li>
        <li>
        ...
        <li>
          Mentored junior developers, fostering their growth and ensuring they
          achieved project goals.
        </li>
        <li>
          Engineered libraries enabling micro-services to dynamically distribute
        ...
        <li>
          ...
          ensuring security ,reliability and improved system performance across
          many micro-services.
        </li>
